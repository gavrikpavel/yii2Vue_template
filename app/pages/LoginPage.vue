<template>
  <div>
    <div v-if="is_logged_in">
      <h1>
        User was successfully LOGGEDDD in. Found user id {{ current_user }}
      </h1>
    </div>
    <div v-else
class="form-horizontal">
      ...
      >
        <label
for="loginform-username" class="col-lg-1 control-label"
          >Username</label
        >
        <div class="col-lg-3">
          <input
...
class="col-lg-8">
      ...
      >
        <label
for="loginform-password" class="col-lg-1 control-label"
          >Password</label
        >
        <div class="col-lg-3">
          <input
        ...
        <div v-if="password_error.length != 0"
class="col-lg-8">
          <p class="help-block help-block-error">
            {{ password_error }}
          </p>
      ...
      <div
class="col-lg-offset-1" style="color: #999"
>
